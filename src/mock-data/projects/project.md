...
summary: "A short one-line summary shown on the project card."
image: "preview.png"
...
Reference an image in the same folder with a relative path:
...
```json
{
  "name": "Example",
  "version": "1.0.0",
  "features": ["tables", "code blocks", "links"]
}
```
